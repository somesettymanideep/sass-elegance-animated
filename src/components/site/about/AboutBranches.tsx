          ...
          {branches.map((b) => (
            ...
            >
              <div className="relative aspect-[4/5] overflow-hidden">
                ...
                <div className="absolute inset-x-0 bottom-0 p-6 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:-translate-y-20">
                ...
                <div className="absolute inset-x-0 bottom-0 translate-y-full p-6 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:translate-y-0">
